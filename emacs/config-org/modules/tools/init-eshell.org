...
(defun mcg/eshell-help ()
  "Show Eshell commands reference in posframe popup."
  (interactive)
  (mcg-popup-show "*Eshell Help*" (mcg--eshell-help-content) 55 30))
