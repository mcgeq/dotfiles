...
#+begin_src emacs-lisp
;;; ============================================================
;;; Keybindings (C-c f prefix - find files)
;;; ============================================================
...
(defun mcg--setup-blink-search-keybindings ()
  ...
  (when (featurep 'blink-search)
    (mcg-bind-key "C-c f b" 'blink-search "tools/blink-search")
    (mcg-bind-key "C-c f d" 'mcg/blink-search-grep-current-dir "tools/blink-search")
    (mcg-bind-key "C-c f p" 'mcg/blink-search-project-root "tools/blink-search"))
