...
#+begin_src emacs-lisp
;;; ============================================================
;;; Keybindings (C-c s prefix - search)
;;; ============================================================

(defun mcg--setup-blink-search-keybindings ()
  "Setup search related keybindings."
  ;; Blink-search - unified search prefix C-c s
  (when (featurep 'blink-search)
    (mcg-bind-key "C-c s b" 'blink-search "tools/blink-search")
    (mcg-bind-key "C-c s d" 'mcg/blink-search-grep-current-dir "tools/blink-search")
    (mcg-bind-key "C-c s p" 'mcg/blink-search-project-root "tools/blink-search"))
...
#+begin_src emacs-lisp
  ...
  (mcg--setup-blink-search-keybindings)
#+end_src
