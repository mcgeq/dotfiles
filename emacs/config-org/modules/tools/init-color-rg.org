...
(defun mcg--setup-search-keybindings ()
  ...
  (when (mcg-require-extension "color-rg" t)
    ...
    (global-set-key (kbd "C-c r g") 'color-rg-search-input)
    (global-set-key (kbd "C-c r G") 'color-rg-search-input-in-project)

    ;; Symbol search
    (global-set-key (kbd "C-c r s") 'color-rg-search-symbol)
    (global-set-key (kbd "C-c r S") 'color-rg-search-symbol-in-project)

    ;; Current file
    (global-set-key (kbd "C-c r .") 'color-rg-search-symbol-in-current-file)
    (global-set-key (kbd "C-c r ,") 'color-rg-search-input-in-current-file)

    ;; Custom search
    (global-set-key (kbd "C-c r t") 'mcg/color-rg-search-project-with-type)
    (global-set-key (kbd "C-c r o") 'mcg/color-rg-search-in-org-directory)
    (global-set-key (kbd "C-c r c") 'mcg/color-rg-search-in-config))
