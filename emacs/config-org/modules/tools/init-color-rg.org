...
#+begin_src emacs-lisp
;;; ============================================================
;;; Keybindings (C-c r prefix - ripgrep)
;;; ============================================================
...
(defun mcg--setup-color-rg-keybindings ()
  ...
  (when (mcg-require-extension "color-rg" t)
    ...
    (mcg-bind-key "C-c r g" 'color-rg-search-input "tools/color-rg")
    (mcg-bind-key "C-c r G" 'color-rg-search-input-in-project "tools/color-rg")

    ;; Symbol search
    (mcg-bind-key "C-c r s" 'color-rg-search-symbol "tools/color-rg")
    (mcg-bind-key "C-c r S" 'color-rg-search-symbol-in-project "tools/color-rg")

    ;; Current file
    (mcg-bind-key "C-c r ." 'color-rg-search-symbol-in-current-file "tools/color-rg")
    (mcg-bind-key "C-c r ," 'color-rg-search-input-in-current-file "tools/color-rg")

    ;; Custom search
    (mcg-bind-key "C-c r t" 'mcg/color-rg-search-project-with-type "tools/color-rg")
    (mcg-bind-key "C-c r o" 'mcg/color-rg-search-in-org-directory "tools/color-rg")
    (mcg-bind-key "C-c r c" 'mcg/color-rg-search-in-config "tools/color-rg"))
