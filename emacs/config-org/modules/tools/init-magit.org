...
(if (mcg-require-extension 'magit t)
    (progn
      ...
      ;; Setup keybindings
      (mcg-bind-key "C-x g" 'magit-status "tools/magit")
      (mcg-bind-key "C-x M-g" 'magit-dispatch "tools/magit")
      (mcg-bind-key "C-c g s" 'magit-status "tools/magit")
      (mcg-bind-key "C-c g l" 'magit-log "tools/magit")
      (mcg-bind-key "C-c g d" 'magit-dispatch "tools/magit")
      (mcg-bind-key "C-c g f" 'magit-file-dispatch "tools/magit")
      (mcg-bind-key "C-c g p" 'magit-push "tools/magit")
      (mcg-bind-key "C-c g P" 'magit-pull "tools/magit")
      (mcg-bind-key "C-c g b b" 'magit-branch-create "tools/magit")
      (mcg-bind-key "C-c g b r" 'magit-branch-rename "tools/magit")
      (mcg-bind-key "C-c g b d" 'magit-branch-delete "tools/magit")
      (mcg-bind-key "C-c g m a" 'magit-submodule-add "tools/magit")
      (mcg-bind-key "C-c g m r" 'magit-submodule-remove "tools/magit")
      (mcg-bind-key "C-c g m u" 'magit-submodule-update "tools/magit")
      (mcg-bind-key "C-c g ?" 'mcg/magit-menu "tools/magit")
