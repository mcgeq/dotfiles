...
(defcustom mcg-org-bullets-alist
  '(("◉" "○" "✸" "✿" "✤" "✜" "◆" "▶")
    ((43 . "◆")
     (45 . "▸")
     (42 . "•")))
  "Unified Org bullets configuration.
Structure: (headline-bullets item-bullet-alist)
where headline-bullets is a list of symbols for each level,
and item-bullet-alist is an alist mapping ASCII codes to bullet characters.

Used by both org-modern and org-superstar for consistent appearance."
  :type '(list (repeat string) (repeat (cons integer string)))
  :group 'mcg-org)

;; Blog-related variables are now in init-org-hugo.el
;; See: mcg-org-blog-directory, mcg-org-blog-development-file, etc.
#+end_src
...
(defun mcg-org-initialize-directories ()
  ...
  ;; Blog directory is initialized by init-org-hugo.el
  (mcg-log "Org directories initialized"))
...
(require 'init-org-hugo)      ; Hugo integration (combines easy-hugo, ox-hugo)
(require 'init-ox-gfm)
