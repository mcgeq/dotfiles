...
(defun mcg--setup-capture-keybindings ()
  ...
  (mcg-bind-key "C-c n c" 'org-capture "org/capture")
  (mcg-bind-key "C-c n a" 'org-agenda "org/capture")
  (mcg-bind-key "C-c n l" 'org-store-link "org/capture")
  (mcg-bind-key "C-c n t" 'org-todo-list "org/capture")
