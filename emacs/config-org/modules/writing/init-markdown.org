...
(defun mcg--setup-grip-mode ()
  ...
  (when (mcg-require-extension "docs/grip-mode" 'grip-mode)
    ;; Bind shortcut to markdown-mode-command-map: C-c C-c g
    ...
    ;; GitHub API configuration (only available for `grip')
    ;; Base URL to another GitHub API
    ...
    ;; Preview hostname (only available for `grip')
    ...
    ;; Auto start grip-mode when opening markdown/org files
