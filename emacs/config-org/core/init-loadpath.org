...
(defvar mcg-extension-registry
  `(
    ...
    ("core/compat"        . (:priority 0 :required t :auto-load nil))  ; Required for transient
    ("core/cond-let"      . (:priority 0 :required t :auto-load nil))  ; Required for magit
    ...
    ("editor/dirvish"         . (:priority 30 :required nil :auto-load nil))
