...
if dap and dapui and vt then
  ...
  if cfg.lua and cfg.lua.enable then
    require("mcge.dap.nvim-dap.config.lua").setup()
  end
  ...
  if cfg.frontend and cfg.frontend.enable then
    require("mcge.dap.nvim-dap.config.vscode-js")
  end

  require("mcge.dap.nvim-dap.common-config").keyAttach()
end
