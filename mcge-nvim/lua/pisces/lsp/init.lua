...
mason_config.setup({
  ensure_installed = require("pisces.env").getLSPEnsureList(),
})

mason_tool.setup({
  ensure_installed = require("pisces.env").getToolEnsureList(),
})

local servers = require("pisces.env").getLSPConfigMap()
