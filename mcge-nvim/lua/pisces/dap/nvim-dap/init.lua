...
if dap and dapui and vt then
  ...
  require("pisces.dap.nvim-dap.ui")
  ...
  if cfg.lua and cfg.lua.enable then
    require("pisces.dap.nvim-dap.config.lua").setup()
  end
  ...
  --   require("pisces.dap.nvim-dap.config.cpp").setup()
  -- end

  if cfg.frontend and cfg.frontend.enable then
    require("pisces.dap.nvim-dap.config.vscode-js")
  end

  require("pisces.dap.nvim-dap.common-config").keyAttach()
end
