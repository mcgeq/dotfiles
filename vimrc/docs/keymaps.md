...
| 快捷键 | 模式 | 动作 | 说明 |
|--------|------|------|------|
| `<leader>rT` | `n` | `:RunnerTestFile` | run tests for current file when supported |
| `<leader>rb` | `n` | `:RunnerBuild` | build current project or buffer target |
| `<leader>rc` | `n` | `:RunnerClean` | clean current project or buffer target |
| `<leader>ri` | `n` | `:RunnerInfo` | show runner info for current buffer |
| `<leader>rl` | `n` | `:RunnerRepeat` | repeat last runner command |
| `<leader>rr` | `n` | `:RunnerRun` | run current project or buffer target |
| `<leader>rt` | `n` | `:RunnerTest` | run current project or package tests |
...
| 快捷键 | 模式 | 动作 | 说明 |
|--------|------|------|------|
| `<leader>PS` | `n` | `:ProjectSessionSelect` | select project and load session |
| `<leader>Pi` | `n` | `:ProjectInfo` | show current project info |
| `<leader>Pp` | `n` | `:ProjectSelect` | select project |
| `<leader>Pr` | `n` | `:ProjectRoot` | set cwd to current project root |
| `<leader>mD` | `n` | `:SessionSelectDelete` | select workspace session to delete |
| `<leader>mS` | `n` | `:SessionSelect` | select workspace session |
| `<leader>md` | `n` | `:SessionDelete` | delete workspace session |
| `<leader>mi` | `n` | `:SessionInfo` | show current workspace session info |
| `<leader>ml` | `n` | `:SessionLoad` | load workspace session |
| `<leader>ms` | `n` | `:SessionSave` | save workspace session |
...
| `<leader>lb` | `n/t` | `:TerminalBufferDir` | open terminal in buffer directory |
| `<leader>lp` | `n/t` | `:TerminalProject` | open terminal in project root |
| `<leader>lt` | `n/t` | `:TerminalCwd` | open terminal in cwd |
...
| `<leader>ur` | `n` | `reload vimrc` | reload configuration |
