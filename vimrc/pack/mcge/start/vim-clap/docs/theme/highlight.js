...
;hljs.registerLanguage("bash",e)})();/*! `diff` grammar compiled for Highlight.js 11.9.0 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `vim` grammar compiled for Highlight.js 11.9.0 */
